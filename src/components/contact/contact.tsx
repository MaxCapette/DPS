...
const ContactPage: React.FC = () => {
    return (
            ...
            <div className="contactCase " >
                <h2 className="text-gray-900 text-3xl font-bold tracking-tight md:text-4xl lg:text-5xl ">Contactez-nous</h2>
                <p className="text-gray-900 md:text-lg lg:text-xl p-10">
